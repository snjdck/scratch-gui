...
class VirtualMachine extends EventEmitter {
    ...
    emitWorkspaceUpdate () {
        ...
        const listMap = Object.assign({},
            this.runtime.getTargetForStage().lists,
            this.editingTarget.lists
        );

        const variables = Object.keys(variableMap).map(k => variableMap[k]);
        const lists = Object.values(listMap).map(v => `<variable type="list">${v.name}</variable>`);
