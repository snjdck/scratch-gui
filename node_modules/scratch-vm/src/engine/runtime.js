...
//            deviceManager: new DeviceManager(),
    ...
    requestAddMonitor (monitor) {
        var monitorID = getVarID(monitor);
        this._monitorState = this._monitorState.set(monitorID, monitor);
    }
    ...
    requestUpdateMonitor (monitor) {
        ...
        if (this._monitorState.has(monitorID)) {
            this._monitorState =
                this._monitorState.set(monitorID, this._monitorState.get(monitorID).merge(monitor));
        }
    }
...
function getVarID(record){
    if(!record.opcode){
        return record.get("id");
    }
    if(record.opcode == "data_variable"){
        return record.params.VARIABLE;
    }
    if(record.opcode == "data_listcontents"){
        return record.params.LIST;
    }
