    ...
    changeBlock (args, optRuntime) {
        ...
        case 'checkbox':
            ...
            if (optRuntime && wasMonitored && !block.isMonitored) {
                var blockID = block.fields.VARIABLE ? block.fields.VARIABLE.value : (block.fields.LIST ? block.fields.LIST.value : block.id)
                optRuntime.requestRemoveMonitor(blockID);
