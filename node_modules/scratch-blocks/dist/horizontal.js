...
/***/ function(module, exports) {
	...
	goog.Disposable.isDisposed=function(a){return a&&"function"==typeof a.isDisposed?a.isDisposed():!1};goog.dispose=function(a){a&&"function"==typeof a.dispose&&a.dispose()};goog.disposeAll=function(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b];goog.isArrayLike(d)?goog.disposeAll.apply(null,d):goog.dispose(d)}};goog.labs.userAgent.platform={};goog.labs.userAgent.platform.isAndroid=function(){return goog.labs.userAgent.util.matchUserAgent("Android")};goog.labs.userAgent.platform.isIpod=function(){return goog.labs.userAgent.util.matchUserAgent("iPod")};goog.labs.userAgent.platform.isIphone=function(){return goog.labs.userAgent.util.matchUserAgent("iPhone")&&!goog.labs.userAgent.util.matchUserAgent("iPod")&&!goog.labs.userAgent.util.matchUserAgent("iPad")};goog.labs.userAgent.platform.isIpad=function(){return goog.labs.userAgent.util.matchUserAgent("iPad")};
	...
	*/
	...
	Blockly.Workspace.prototype.getBlockById=function(a){var b=this.blockDB_[a];!b&&this.getFlyout()&&this.getFlyout().getWorkspace()&&(b=this.getFlyout().getWorkspace().blockDB_[a]);return b||null};Blockly.Workspace.prototype.getFlyout=function(){return null};Blockly.Workspace.prototype.allInputsFilled=function(a){for(var b=this.getTopBlocks(!1),c=0,d;d=b[c];c++)if(!d.allInputsFilled(a))return!1;return!0};Blockly.Workspace.prototype.getVariablesOfType=function(a){return this.variableMap_.getVariablesOfType(a)};
	Blockly.Workspace.prototype.getVariableTypes=function(){return this.variableMap_.getVariableTypes()};Blockly.Workspace.prototype.getAllVariables=function(){return this.variableMap_.getAllVariables()};Blockly.Workspace.WorkspaceDB_=Object.create(null);Blockly.Workspace.getById=function(a){return Blockly.Workspace.WorkspaceDB_[a]||null};Blockly.Workspace.prototype.clear=Blockly.Workspace.prototype.clear;Blockly.Workspace.prototype.clearUndo=Blockly.Workspace.prototype.clearUndo;
	...
	Blockly.Variables.allVariables=function(a){return a instanceof Blockly.Block?(console.warn("Deprecated call to Blockly.Variables.allVariables with a block instead of a workspace.  You may want Blockly.Variables.allUsedVariables"),{}):a.getAllVariables()};Blockly.Variables.createValueDom_=function(a){var b=goog.dom.createDom("value");b.setAttribute("name",a);return b};Blockly.Variables.createShadowDom_=function(a){var b=goog.dom.createDom("shadow");b.setAttribute("type",a);return b};
	Blockly.Variables.createVariableDom_=function(a){var b=goog.dom.createDom("field",null,a.name);b.setAttribute("name","VARIABLE");b.setAttribute("variableType",a.type);b.setAttribute("id",a.getId());return b};Blockly.Variables.createTextDom_=function(){var a=Blockly.Variables.createValueDom_("VALUE"),b=Blockly.Variables.createShadowDom_("text"),c=goog.dom.createDom("field",null,"0");c.setAttribute("name","TEXT");b.appendChild(c);a.appendChild(b);return a};
	...
	b),Blockly.DataCategory.addHideList(c,b));return c};Blockly.DataCategory.addDataVariable=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_variable","VARIABLE")};Blockly.DataCategory.addSetVariableTo=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_setvariableto","VARIABLE",["VALUE","text"])};Blockly.DataCategory.addChangeVariableBy=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_changevariableby","VARIABLE",["VALUE","math_number"])};
	Blockly.DataCategory.addShowVariable=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_showvariable","VARIABLE")};Blockly.DataCategory.addHideVariable=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_hidevariable","VARIABLE")};Blockly.DataCategory.addAddToList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_addtolist","LIST",["ITEM","text"])};Blockly.DataCategory.addDeleteOfList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_deleteoflist","LIST",["INDEX","math_integer"])};
	Blockly.DataCategory.addInsertAtList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_insertatlist","LIST",["INDEX","math_integer"],["ITEM","text"])};Blockly.DataCategory.addReplaceItemOfList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_replaceitemoflist","LIST",["INDEX","math_integer"],["ITEM","text"])};Blockly.DataCategory.addItemOfList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_itemoflist","LIST",["INDEX","math_integer"])};
	Blockly.DataCategory.addLengthOfList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_lengthoflist","LIST")};Blockly.DataCategory.addListContainsItem=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_listcontainsitem","LIST",["ITEM","text"])};Blockly.DataCategory.addShowList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_showlist","LIST")};Blockly.DataCategory.addHideList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_hidelist","LIST")};
	...
	Blockly.DataCategory.addBlock=function(a,b,c,d,e,f){if(Blockly.Blocks[c]){var g,h;e&&(g=Blockly.DataCategory.createValue(e[0],e[1]));f&&(h=Blockly.DataCategory.createValue(f[0],f[1]));b='<xml><block type="'+c+'" gap="8">'+Blockly.Variables.generateVariableFieldXml_(b,d)+g+h+"</block></xml>";b=Blockly.Xml.textToDom(b).firstChild;a.push(b)}};
	Blockly.DataCategory.createValue=function(a,b){switch(a){case "ITEM":var c="TEXT";var d="thing";break;case "INDEX":c="NUM";d=1;break;case "VALUE":c="math_number"===b?"NUM":"TEXT",d=0}return'<value name="'+a+'"><shadow type="'+b+'"><field name="'+c+'">'+d+"</field></shadow></value>"};Blockly.DropDownDiv=function(){};Blockly.DropDownDiv.DIV_=null;Blockly.DropDownDiv.boundsElement_=null;Blockly.DropDownDiv.owner_=null;Blockly.DropDownDiv.ARROW_SIZE=16;Blockly.DropDownDiv.BORDER_SIZE=1;Blockly.DropDownDiv.ARROW_HORIZONTAL_PADDING=12;Blockly.DropDownDiv.PADDING_Y=20;Blockly.DropDownDiv.ANIMATION_TIME=.25;Blockly.DropDownDiv.animateOutTimer_=null;Blockly.DropDownDiv.onHide_=0;
	...
	Blockly.InsertionMarkerManager.prototype.createMarkerBlock_=function(a){var b=a.type;Blockly.Events.disable();try{var c=this.workspace_.newBlock(b);if(a.mutationToDom){var d=a.mutationToDom();c.domToMutation(d)}c.setInsertionMarker(!0,a.width);c.initSvg()}finally{Blockly.Events.enable()}return c};
	...
	void 0===m&&(m=!1);var n=a.toolboxPosition;n="end"===n?!1:!0;var p=m?n?Blockly.TOOLBOX_AT_TOP:Blockly.TOOLBOX_AT_BOTTOM:n==l?Blockly.TOOLBOX_AT_RIGHT:Blockly.TOOLBOX_AT_LEFT;var q=a.scrollbars;void 0===q&&(q=f);var u=a.css;void 0===u&&(u=!0);var v="https://blockly-demo.appspot.com/static/media/";a.media?v=a.media:a.path&&(v=a.path+"media/");n=void 0===a.oneBasedIndex?!0:!!a.oneBasedIndex;var w=!!a.realtime,x=w?a.realtimeOptions:void 0,r=a.colours;if(r)for(var t in r)r.hasOwnProperty(t)&&Blockly.Colours.hasOwnProperty(t)&&
	...
	Blockly.Xml.domToBlockHeadless_=function(a,b){var c=null,d=a.getAttribute("type");goog.asserts.assert(d,"Block type unspecified: %s",a.outerHTML);var e=a.getAttribute("id");c=b.newBlock(d,e);for(var f=null,g=0,h;h=a.childNodes[g];g++)if(3!=h.nodeType){var k=null,l=null;f=0;for(var m;m=h.childNodes[f];f++)1==m.nodeType&&("block"==m.nodeName.toLowerCase()?k=m:"shadow"==m.nodeName.toLowerCase()&&(l=m));!k&&l&&(k=l);f=h.getAttribute("name");switch(h.nodeName.toLowerCase()){case "mutation":c.domToMutation&&
	(c.domToMutation(h),c.initSvg&&c.initSvg());break;case "comment":c.setCommentText(h.textContent);var n=h.getAttribute("pinned");n&&!c.isInFlyout&&setTimeout(function(){c.comment&&c.comment.setVisible&&c.comment.setVisible("true"==n)},1);f=parseInt(h.getAttribute("w"),10);h=parseInt(h.getAttribute("h"),10);!isNaN(f)&&!isNaN(h)&&c.comment&&c.comment.setVisible&&c.comment.setBubbleSize(f,h);break;case "data":c.data=h.textContent;break;case "title":case "field":k=c.getField(f);l=h.textContent;if(k instanceof
	Blockly.FieldVariable||k instanceof Blockly.FieldVariableGetter){m=h.getAttribute("variableType")||"";var p=b.getVariable(l);p||(p=b.createVariable(l,m,h.getAttribute(e)));if(null!==m&&m!==p.type)throw Error("Serialized variable type with id '"+p.getId()+"' had type "+p.type+", and does not match variable field that references it: "+Blockly.Xml.domToText(h)+".");}if(!k){console.warn("Ignoring non-existent field "+f+" in block "+d);break}k.setValue(l);break;case "value":case "statement":h=c.getInput(f);
	if(!h){console.warn("Ignoring non-existent input "+f+" in block "+d);break}l&&h.connection.setShadowDom(l);k&&(f=Blockly.Xml.domToBlockHeadless_(k,b),f.outputConnection?h.connection.connect(f.outputConnection):f.previousConnection?h.connection.connect(f.previousConnection):goog.asserts.fail("Child block does not have output or previous statement."));break;case "next":l&&c.nextConnection&&c.nextConnection.setShadowDom(l);k&&(goog.asserts.assert(c.nextConnection,"Next statement does not exist."),goog.asserts.assert(!c.nextConnection.isConnected(),
	"Next statement is already connected."),f=Blockly.Xml.domToBlockHeadless_(k,b),goog.asserts.assert(f.previousConnection,"Next block does not have previous statement."),c.nextConnection.connect(f.previousConnection));break;default:console.warn("Ignoring unknown tag: "+h.nodeName)}}(g=a.getAttribute("inline"))&&c.setInputsInline("true"==g);(g=a.getAttribute("disabled"))&&c.setDisabled("true"==g);(g=a.getAttribute("deletable"))&&c.setDeletable("true"==g);(g=a.getAttribute("movable"))&&c.setMovable("true"==
	g);(g=a.getAttribute("editable"))&&c.setEditable("true"==g);(g=a.getAttribute("collapsed"))&&c.setCollapsed("true"==g);if("shadow"==a.nodeName.toLowerCase()){d=c.getChildren();for(g=0;e=d[g];g++)goog.asserts.assert(e.isShadow(),"Shadow block not allowed non-shadow child.");goog.asserts.assert(0==c.getVars().length,"Shadow blocks cannot have variable fields.");c.setShadow(!0)}return c};
	...
	for(var l;l=k[d];d++){var m=l.getRelativeToSurfaceXY();if(1>=Math.abs(f-m.x)&&1>=Math.abs(g-m.y)){h=!0;break}}if(!h){var n=b.getConnections_(!1);d=0;for(var p;p=n[d];d++)if(p.closest(Blockly.SNAP_RADIUS,new goog.math.Coordinate(f,g)).connection){h=!0;break}}h&&(f=this.RTL?f-Blockly.SNAP_RADIUS:f+Blockly.SNAP_RADIUS,g+=2*Blockly.SNAP_RADIUS)}while(h);b.moveBy(f,g)}}finally{Blockly.Events.enable()}Blockly.Events.isEnabled()&&!b.isShadow()&&Blockly.Events.fire(new Blockly.Events.BlockCreate(b));b.select()}};
	...
	b+=10};k={enabled:k};k.text=Blockly.Msg.COLLAPSE_ALL;k.callback=function(){n(!0)};d.push(k);h={enabled:h};h.text=Blockly.Msg.EXPAND_ALL;h.callback=function(){n(!1)};d.push(h)}var p=[];for(l=0;l<e.length;l++)b(e[l]);var q=0;for(l=0;l<p.length;l++)p[l].isShadow()||q++;h={text:1==q?Blockly.Msg.DELETE_BLOCK:Blockly.Msg.DELETE_X_BLOCKS.replace("%1",String(q)),enabled:0<q,callback:function(){g.currentGesture_&&g.currentGesture_.cancel();2>p.length?c():Blockly.confirm(Blockly.Msg.DELETE_ALL_BLOCKS.replace("%1",
	String(q)),function(a){a&&c()})}};d.push(h);Blockly.ContextMenu.show(a,d,this.RTL)}};
	...
	Blockly.WorkspaceSvg.prototype.updateStackGlowScale_=function(){this.options.stackGlowBlur&&this.options.stackGlowBlur.setAttribute("stdDeviation",Blockly.STACK_GLOW_RADIUS/this.scale)};
	...
	b=0;for(var c;c=this.inputList[b];b++)c.dispose();this.inputList.length=0;var d=this.getConnections_(!0);for(b=0;b<d.length;b++){var e=d[b];e.isConnected()&&e.disconnect();d[b].dispose()}}finally{Blockly.Events.enable()}}};
	...
	Blockly.RENAME_VARIABLE_ID]);c.push([Blockly.Msg.DELETE_VARIABLE.replace("%1",b),Blockly.DELETE_VARIABLE_ID]);return c};
	...
	Blockly.FlyoutButton.prototype.createDom=function(){var a,b=this.isLabel_?"blocklyFlyoutLabel":"blocklyFlyoutButton";this.cssClass_&&(b+=" "+this.cssClass_);this.svgGroup_=Blockly.utils.createSvgElement("g",{"class":b},this.workspace_.getCanvas());this.isLabel_||(a=Blockly.utils.createSvgElement("rect",{"class":"blocklyFlyoutButtonShadow",rx:4,ry:4,x:1,y:1},this.svgGroup_));b=Blockly.utils.createSvgElement("rect",{"class":this.isLabel_?"blocklyFlyoutLabelBackground":"blocklyFlyoutButtonBackground",
	...
	Blockly.Toolbox.prototype.init=function(){var a=this.workspace_,b=this.workspace_.getParentSvg();this.HtmlDiv=goog.dom.createDom("DIV","blocklyToolboxDiv");this.HtmlDiv.setAttribute("dir",a.RTL?"RTL":"LTR");b.parentNode.insertBefore(this.HtmlDiv,b);Blockly.bindEventWithChecks_(this.HtmlDiv,"mousedown",this,function(a){Blockly.utils.isRightButton(a)||a.target==this.HtmlDiv?Blockly.hideChaff(!1):Blockly.hideChaff(!0);Blockly.Touch.clearTouchIdentifier()});this.createFlyout_();this.categoryMenu_=new Blockly.Toolbox.CategoryMenu(this,
	this.HtmlDiv);this.populate_(a.options.languageTree);this.position()};Blockly.Toolbox.prototype.dispose=function(){this.flyout_.dispose();this.categoryMenu_.dispose();this.categoryMenu_=null;goog.dom.removeNode(this.HtmlDiv);this.lastCategory_=this.workspace_=null};
	...
	"background: #faa;","}",".blocklyAngleCircle {","stroke: "+Blockly.Colours.motion.tertiary+";","stroke-width: 1;","fill: "+Blockly.Colours.motion.secondary+";","}",".blocklyAngleCenterPoint {","stroke: #fff;","stroke-width: 1;","fill: #fff;","}",".blocklyAngleDragHandle {","stroke: #fff;","stroke-width: 5;","stroke-opacity: 0.25;","fill: #fff;","cursor: pointer;","}",".blocklyAngleMarks {","stroke: #fff;","stroke-width: 1;","stroke-opacity: 0.5;","}",".blocklyAngleGauge {","fill: #fff;","fill-opacity: 0.20;",
	"}",".blocklyAngleLine {","stroke: #fff;","stroke-width: 1;","stroke-linecap: round;","pointer-events: none;","}",".blocklyContextMenu {","border-radius: 4px;","}",".blocklyDropdownMenu {","padding: 0 !important;","}",".blocklyDropDownNumPad {","background-color: $colour_numPadBackground;","}",".blocklyWidgetDiv .goog-option-selected .goog-menuitem-checkbox,",".blocklyWidgetDiv .goog-option-selected .goog-menuitem-icon {","background: url(<<<PATH>>>/sprites.png) no-repeat -48px -16px !important;",
