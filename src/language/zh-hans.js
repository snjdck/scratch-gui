...
Blockly.Msg.PROJECT = "项目";
Blockly.Msg.ADD_COMMENT = "添加注释";
Blockly.Msg.AUTH = "请授权这个应用程序以保存您的作品并共享。";
Blockly.Msg.ARDUINO_BOARD = "Arduino开发板类型";
Blockly.Msg.ARDUINO_PATH = "Arduino路径";
Blockly.Msg.BUG_REPORT = "问题反馈";
Blockly.Msg.BUG_REPORT_DESC = "Bug 描述";
Blockly.Msg.BUG_REPORT_EMAIL = "请输入您的Email以联系您:)";
Blockly.Msg.BUG_REPORT_GREET = "您好，您叫什么名字";
Blockly.Msg.BUG_REPORT_SEND = "发送报告";
...
Blockly.Msg.EXAMPLE = "例子";
Blockly.Msg.EXAMPLE_PROJECT = "示例项目";
...
Blockly.Msg.LOAD = "读取";
Blockly.Msg.LOAD_FROM_FILE = "从文件读取";
Blockly.Msg.LOAD_PROJECT = "读取项目";
...
Blockly.Msg.PROJECT_NAME = "项目名称";
Blockly.Msg.REDO = "重做";
Blockly.Msg.REMOVE_COMMENT = "删除注释";
Blockly.Msg.RENAME_VARIABLE = "重命名变量...";
Blockly.Msg.RENAME_VARIABLE_TITLE = "将所有“%1”变量重命名为:";
Blockly.Msg.RESTORE = "恢复出厂固件";
Blockly.Msg.SAVE = "保存";
Blockly.Msg.SAVE_CONFIG = "保存设置";
Blockly.Msg.SAVE_PROJECT = "保存工程";
Blockly.Msg.SAVE_TO_FILE = "保存到文件";
Blockly.Msg.SEND = "发送";
Blockly.Msg.CLEAR = "清空";
Blockly.Msg.SERIAL_PORT_NOTCONNECTED = "没有连接";
Blockly.Msg.SET = "设置";
Blockly.Msg.SETUP_MENU = "设置菜单";
...
Blockly.Msg.TRANSLATE = "翻译";
Blockly.Msg.UNDO = "撤销";
Blockly.Msg.UPLOAD = "上传";
...
Blockly.Msg.STAGE = "舞台";
Blockly.Msg.IPCONNECTION = "Ip 连接";
Blockly.Msg.OPENWITHARDUINO = "使用Arduino打开";
Blockly.Msg.MOTION = "动作";
Blockly.Msg.MOTION_MOVEBYSTEP = "移动 %1 步";
Blockly.Msg.MOTION_TURNRIGHT = "向右旋转 %1 %2 度";
Blockly.Msg.MOTION_TURNLEFT = "向左旋转 %1 %2 度";
Blockly.Msg.MOTION_POINTINDIRECTION = "指向方向 %1";
...
Blockly.Msg.LOOKS_SETEFFECT = "将 %1 设定为 %2";
...
Blockly.Msg.LOOKS_SWITCHBACKDROP = "将背景切换为 %1";
...
Blockly.Msg.SOUND = "声音";
Blockly.Msg.SOUND_PLAY = "播放 %1";
Blockly.Msg.SOUND_PLAYUTILDONE = "播放 %1 直到播放完毕";
Blockly.Msg.SOUND_PLAYWITHPITCH = "使用音调 %2 播放 %1";
Blockly.Msg.SOUND_STOPALLSOUND = "停止所有声音";
Blockly.Msg.SOUND_CHANGEVOLUMEBY = "将音量增加%1";
Blockly.Msg.SOUND_SETVOLUMETO = "将音量设定为%1%";
Blockly.Msg.SOUND_VOLUME = "音量";
Blockly.Msg.SOUND_CHANGETEMPOBY = "将节奏加快%1";
Blockly.Msg.SOUND_SETTEMPOTOBPM = "将节奏设定为 %1 bpm";
Blockly.Msg.SOUND_TEMPO = "节奏";
Blockly.Msg.SOUND_PLAYDRUM = "弹奏鼓声 %1";
Blockly.Msg.SOUND_PLAYDRUMFORBEATS = "弹奏鼓声 %1 %2 拍";
Blockly.Msg.SOUND_RESTFORBEATS = "停止 %1 拍";
Blockly.Msg.SOUND_PLAYNOTE = "弹奏音符 %1";
Blockly.Msg.SOUND_PLAYNOTEFORBEATS = "弹奏音符 %1 %2 拍";
Blockly.Msg.SOUND_SETKEY = "set key %1 %2";
Blockly.Msg.SOUND_SETEFFECTTO = "将特效 %1 改变为 %2";
Blockly.Msg.SOUND_CHANGEEFFECTBY = "改变特效 %1 %2";
Blockly.Msg.SOUND_CLEAREFFECTS = "清除所有音效";
Blockly.Msg.SOUND_SETINSTRUMENTTO = "设定乐器为 %1";
...
Blockly.Msg.PEN_SETPENCOLORTO = "将画笔的颜色设定为%1";
Blockly.Msg.PEN_CHANGEPENCOLORBY = "将画笔的颜色值增加%1";
Blockly.Msg.PEN_SETPENCOLORTO = "将画笔的颜色设定为%1";
Blockly.Msg.PEN_CHANGEPENSHADEBY = "将画笔的色度增加%1";
Blockly.Msg.PEN_SETPENSHADETO = "讲画笔的色度设定为%1";
Blockly.Msg.PEN_CHANGEPENSIZEBY = "将画笔的大小增加%1";
...
Blockly.Msg.DATA_ADDTO = "将%1加到链表%2末尾";
Blockly.Msg.DATA_DELETE = "删除第%1项，从链表%2";
Blockly.Msg.DATA_INSERT = "插入：%1 位置：%2到链表：%3";
Blockly.Msg.DATA_REPLACEITEMOFWITH = "替换位置：%1链表：%2内容：%3";
Blockly.Msg.DATA_ITEMOF = "第%1项%2";
Blockly.Msg.DATA_LENGTHOF = "链表%1的长度";
...
Blockly.Msg.EVENTS_WHENIRECEIVE = "当接收到%1";
Blockly.Msg.EVENTS_WHENBACKINGSWITCHESTO = "当背景切换到%1";
Blockly.Msg.EVENTS_WHEN = "当%1 > %2";
Blockly.Msg.EVENTS_BROADCAST = "广播%1";
Blockly.Msg.EVENTS_BROADCASTANDWAIT = "广播%1并等待";
Blockly.Msg.EVENTS_WHENKEYPRESSED = "当按下%1";

Blockly.Msg.CONTROL = "控制";
Blockly.Msg.CONTROL_FOREVER = "重复执行";
Blockly.Msg.CONTROL_REPEAT = "重复执行%1";
Blockly.Msg.CONTROL_IFTHEN = "如果%1那么";
Blockly.Msg.CONTROL_ELSE = "否则";
Blockly.Msg.CONTROL_WAITSECS = "等待%1秒";
Blockly.Msg.CONTROL_WAITUNTIL = "在%1之前一直等待";
...
Blockly.Msg.SENSING_COLORISTOUCHING = "颜色%1碰到%2?"
Blockly.Msg.SENSING_DISTANCE = "到%1的距离"
Blockly.Msg.SENSING_ASKANDWAIT = "询问%1并等待"
Blockly.Msg.SENSING_ANSWER = "回答"
Blockly.Msg.SENSING_KEYPRESSED = "按键%1是否按下?"
Blockly.Msg.SENSING_MOUSEDOWN = "鼠标键被按下了吗?"
Blockly.Msg.SENSING_MOUSEX = "鼠标的x坐标"
Blockly.Msg.SENSING_MOUSEY = "鼠标的y坐标"
Blockly.Msg.SENSING_LOUDNESS = "响度"
Blockly.Msg.SENSING_VIDEOON = "视频侦测%1在%2上"
Blockly.Msg.SENSING_TURNVIDEO = "将摄像头%1"
Blockly.Msg.SENSING_SETVIDEOTRANSPARENCYTO = "将视频透明度设置为%1%"
Blockly.Msg.SENSING_TIMER = "计时器"
Blockly.Msg.SENSING_RESETTIMER = "计时器归零"
Blockly.Msg.SENSING_OF = "获取%1属于%2"
...
Blockly.Msg.OPERATORS_AND = "%1与%2"
Blockly.Msg.OPERATORS_OR = "%1或%2"
Blockly.Msg.OPERATORS_NOT = "%1不成立"
Blockly.Msg.OPERATORS_JOIN = "合并%1与%2"
Blockly.Msg.OPERATORS_LETTEROF = "第%1个字符：%2"
Blockly.Msg.OPERATORS_LENGTHOF = "%1的长度"
Blockly.Msg.OPERATORS_MOD = "%1除以%2的余数"
Blockly.Msg.OPERATORS_ROUND = "将%1四舍五入"
Blockly.Msg.OPERATORS_OF = "%1 %2"

Blockly.Msg.ARDUINO_BEGIN = "Arduino程序开始";
Blockly.Msg.ARDUINO_PINMODE = "引脚%1 %2";
Blockly.Msg.ARDUINO_DIGITALREAD = "读数字电平 %1";
Blockly.Msg.ARDUINO_DIGITALWRITE = "设置引脚 %1 电平 %2";
Blockly.Msg.ARDUINO_ANALOGREAD = "模拟读 %1";
Blockly.Msg.ARDUINO_ANALOGWRITE = "模拟写 %1 PWM %2";
Blockly.Msg.ARDUINO_TONE = "蜂鸣器 %1 %2赫兹 %3毫秒";
Blockly.Msg.ARDUINO_SERVO = "舵机 引脚%1 %2度";
Blockly.Msg.ARDUINO_PULSEIN = "脉冲输入 %1";
Blockly.Msg.ARDUINO_PRINTLN = "打印 %1";
Blockly.Msg.ARDUINO_HIGH = "高电平";
Blockly.Msg.ARDUINO_LOW = "低电平";
Blockly.Msg.ARDUINO_INPUT = "输入";
Blockly.Msg.ARDUINO_OUTPUT = "输出";
...
// added after v1.23
Blockly.Msg.SPRITE = "角色";
Blockly.Msg.COSTUMES = "外观";
Blockly.Msg.SOUNDS = "声音";
Blockly.Msg.WIRING = "连线";
Blockly.Msg.SHOW = "显示";
...
Blockly.Msg.KB_STEPPER = "步进电机 %1 %2 角度 %3 RPM";
Blockly.Msg.KB_STEPPERDUAL = "步进电机 %1 角度 %2 RPM, %3 角度 %4 RPM";
Blockly.Msg.KB_STOPMOTOR = "停止所有直流电机";
Blockly.Msg.KB_RGB = "RGB 管脚 %1 像素 %2 颜色 %3";
Blockly.Msg.KB_POWER = "板载光线传感器";
Blockly.Msg.KB_PING = "超声波 触发引脚 %1 响应引脚 %2";
Blockly.Msg.KB_LCD = "LCD屏幕 %1";
Blockly.Msg.KB_DIGITAL = "数码管 CLK %1 DIO %2 数字 %3";
Blockly.Msg.KB_INFRARX = "红外接收 引脚 %1";
Blockly.Msg.KB_MATRIXATTACH = "LED矩阵连接 IO%1 CLK%2 CS%3";
Blockly.Msg.KB_MATRIXPIX = "LED矩阵显示 行%1  列%2 数值 %3";
Blockly.Msg.WB_DCMOTOR = "直流电机 %1 速度 %2";
Blockly.Msg.WB_MOTOR_MOVE = "电机移动 %1 %2";
Blockly.Msg.WB_BOARD_SERVO = "舵机 %1 角度 %2";
Blockly.Msg.WB_TONE = "播放音调 %1 节拍 %2";
Blockly.Msg.WB_ENCODER_MOVE = "编码电机 %1 速度 %2 距离 %3 厘米";
...
Blockly.Msg.WB_BOARD_BUTTON = "按钮 %1 按下";
Blockly.Msg.WB_IR = "红外传感器 %1 按下 %2";
Blockly.Msg.WB_LINE_FOLLOWER = "巡线传感器 %1 %2";
Blockly.Msg.WB_ULTRASONIC = "超声波传感器 %1";
Blockly.Msg.WB_ULTRASONIC_LED = "设置超声波传感器 %1 灯 %2 %3";
Blockly.Msg.WB_LED_MATRIX_NUMBER = "表情面板 %1 显示数字 %2";
Blockly.Msg.WB_LED_MATRIX_TIME = "表情面板 %1 显示时间 %2 %3 %4";
Blockly.Msg.WB_LED_MATRIX_STRING = "表情面板 %1 x:%2 y:%3 显示字符 %4";
...
Blockly.Msg.WB_Right = "右";
Blockly.Msg.WB_Both = "全部";
Blockly.Msg.WB_Port1 = "端口1";
Blockly.Msg.WB_Port2 = "端口2";
Blockly.Msg.WB_Port3 = "端口3";
Blockly.Msg.WB_Port4 = "端口4";
Blockly.Msg.WB_Port5 = "端口5";
Blockly.Msg.WB_Port6 = "端口6";
Blockly.Msg.WB_PortA = "端口A";
Blockly.Msg.WB_PortB = "端口B";
Blockly.Msg.WB_PortC = "端口C";
Blockly.Msg.WB_PortD = "端口D ";
Blockly.Msg.WB_OnBoard = "板载";
Blockly.Msg.WB_TONE_Half = "二分之一";
Blockly.Msg.WB_TONE_Quarter = "四分之一";
Blockly.Msg.WB_TONE_Eighth = "八分之一";
...
Blockly.Msg.SCRATCH_DIRECTION = "方向";
Blockly.Msg.SCRATCH_ROTATION_LEFT_RIGHT = "左右旋转";
Blockly.Msg.SCRATCH_ROTATION_NONE = "禁止旋转";
Blockly.Msg.SCRATCH_ROTATION_ANY = "任意旋转";
Blockly.Msg.SCRATCH_ADD_BACKDROP = "添加背景";
Blockly.Msg.SCRATCH_ADD_SPRITE = "添加角色";
Blockly.Msg.SCRATCH_BACKDROPS = "背景";
Blockly.Msg.SCRATCH_ADD_COSTUME = "添加造型";
Blockly.Msg.SCRATCH_SPRITE_LIBRARY = "角色库";
Blockly.Msg.SCRATCH_BACKDROP_LIBRARY = "背景库";
Blockly.Msg.SCRATCH_COSTUME_LIBRARY = "造型库";
Blockly.Msg.SCRATCH_MOUSE_POINTER = "鼠标指针";
Blockly.Msg.SCRATCH_RANDOM_POSITION = "随机位置";
Blockly.Msg.SCRATCH_WHAT_ARE_YOU_LOOKING_FOR = "你想找什么?";
Blockly.Msg.SOUND_FASTER = "加速";
Blockly.Msg.SOUND_SLOWER = "减速";
Blockly.Msg.SOUND_ECHO = "回声";
Blockly.Msg.SOUND_ROBOT = "机器人";
Blockly.Msg.SOUND_LOUDER = "增大";
Blockly.Msg.SOUND_SOFTER = "减小";
Blockly.Msg.SOUND_REVERSE = "反转";
Blockly.Msg.SOUND_ADD = "添加声音";
Blockly.Msg.SOUND_RECORD = "录音";
Blockly.Msg.WC_RESTORE_FIRMWARE = "恢复程序";
Blockly.Msg.WC_RESTORE_ONLINE_FIRMWARE = "恢复在线程序";
Blockly.Msg.WC_RESTORE_FACTORY_FIRMWARE = "恢复出厂程序";
...
Blockly.Msg.SCRATCH_SOUND_LIBRARY = "声音库";
Blockly.Msg.WC_SOUND_STOP = "停止";
Blockly.Msg.WC_SOUND_PLAY = "播放";
Blockly.Msg.WC_SOUND_SOUND = "声音";
Blockly.Msg.WC_SOUND_TRIM = "剪裁";
Blockly.Msg.WC_SOUND_UNDO = "撤销";
Blockly.Msg.WC_SOUND_REDO = "重做";
Blockly.Msg.SCRATCH_GO = "开始";
Blockly.Msg.SCRATCH_NEW_MESSAGE = "新建消息";
Blockly.Msg.WB_SINGLE_LINE_FOLLOWER = "单路巡线传感器%1";
Blockly.Msg.WB_IR_AVOID = "红外避障传感器检测到障碍? %1";
Blockly.Msg.WB_MINI_FRONT_LED = "车前灯 %1 %2 %3";
Blockly.Msg.WB_MINI_BACK_LED = "车尾灯 %1 %2";
Blockly.Msg.WB_IR_AVOID_LED = "红外避障传感器 %1 灯 %2 %3";
Blockly.Msg.WB_IR_AVOID_LED_RGB = "红外避障传感器 %1 灯 %2 红 %3 绿 %4 蓝 %5";
Blockly.Msg.WB_BOARD_IR_PRESSED = "红外传感器按下 %1";
Blockly.Msg.WB_MINI_LEFT_RED = "左侧红色";
Blockly.Msg.WB_MINI_LEFT_YELLOW = "左侧黄色";
Blockly.Msg.WB_MINI_RIGHT_RED = "右侧红色";
Blockly.Msg.WB_MINI_RIGHT_YELLOW = "右侧黄色";
Blockly.Msg.ON = "打开";
Blockly.Msg.OFF = "关闭";
Blockly.Msg.WB_HUMITURE_HUMIDITY = "温湿度传感器 %1 湿度";
Blockly.Msg.WB_HUMITURE_TEMPERATURE = "温湿度传感器 %1 温度";
Blockly.Msg.WB_TOUCH = "触摸传感器 %1";
...
Blockly.Msg.WB_LED_BUTTON_LIGHT = "LED按键传感器 %1 %2 %3";
Blockly.Msg.WB_RELAY = "继电器 %1 %2";
Blockly.Msg.WB_WATER_ATOMIZER = "雾化器 %1 %2";
Blockly.Msg.WB_COLOR_SENSOR_WHITE_BALANCE = "设置颜色传感器 %1 白平衡";
Blockly.Msg.WB_COLOR_SENSOR_LIGHT = "设置颜色传感器 %1 灯 %2";
Blockly.Msg.WB_MP3_PLAY = "MP3 %1 恢复播放";
Blockly.Msg.WB_MP3_PAUSE = "MP3 %1 暂停播放";
Blockly.Msg.WB_MP3_NEXT_MUSIC = "MP3 %1 下一首";
Blockly.Msg.WB_MP3_SET_MUSIC = "MP3 %1 播放第 %2 首";
Blockly.Msg.WB_MP3_SET_VOLUME = "MP3 %1 设置音量 %2";
Blockly.Msg.WB_MP3_SET_DEVICE = "MP3 %1 设置播放设备 %2";
Blockly.Msg.WB_MP3_IS_OVER = "MP3 %1 播放是否结束";
Blockly.Msg.WB_OLED_SET_SIZE = "OLED %1 设置尺寸 %2";
Blockly.Msg.WB_OLED_SHOW_STRING = "OLED %1 x %2 y %3 显示字符 %4";
Blockly.Msg.WB_OLED_SHOW_NUMBER = "OLED %1 x %2 y %3 显示数字 %4";
Blockly.Msg.WB_OLED_CLEAR_SCREEN = "OLED %1 清空屏幕";
Blockly.Msg.WB_COLOR_SENSOR = "颜色传感器 %1 %2";
Blockly.Msg.WB_FLAME_SENSOR = "火焰传感器 %1 %2";
Blockly.Msg.WB_JOYSTICK = "摇杆 %1 %2";
Blockly.Msg.WB_COMPASS = "电子罗盘 %1 %2";
Blockly.Msg.WB_GYRO_GYRATION = "陀螺仪 %1 %2 角度";
Blockly.Msg.WB_GYRO_ACCELERATION = "陀螺仪 %1 %2 加速度";
Blockly.Msg.WB_TOUCH = "触摸传感器 %1";
Blockly.Msg.WB_LED_BUTTON = "LED按键传感器 %1 %2 已按下?";
Blockly.Msg.WB_PIR = "人体红外传感器 %1";
Blockly.Msg.WB_TILT = "倾斜传感器 %1 %2";
Blockly.Msg.WB_LIMIT_SWITCH = "限位开关 %1";
Blockly.Msg.COLOUR_LIGHT = "亮度";
